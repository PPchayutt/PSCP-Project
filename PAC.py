...
def bunny_to_human_age(bunny_age):
    age_table = {
        1: 21, 2: 27, 3: 33, 4: 39, 5: 45, 6: 51, 7: 57, 8: 63, 9: 69,
...
def hedgehog_to_human_age(hedgehog_age):
    age_table = {
        ...
        3.67: 60,    # 3 years 8 months
        4.17: 70,    # 4 years 2 months
        5.33: 80,    # 5 years 4 months
        6.17: 90,    # 6 years 2 months
        7.67: 100    # 7 years 8 months
    }
...
def squirrel_to_human_age(squirrel_age):
    age_table = {
        1: 8.89, 2: 17.78, 3: 26.67, 4: 35.56, 5: 44.45,
